...
if __name__ == '__main__':
    try:
        ...
        cfg.DATASET.NAME = "smoke_dataset"
        # cfg.DATASET.ROOT = "./datasets/smoke_dataset"
        ...
        # cfg.freeze()
        print(cfg) # print the final config used for the experiment
        ...
        if cfg.MODEL.IS_TRAIN:
            ...
            if cfg.TEST.ABLATION:
                ...
                # qualitative
                mask_path = "datasets/smoke_dataset/train/mask/M_15583.png"
                ...
                # datasets / smoke_dataset / test / smoke / M_00000.png
                # raindrop_img_path = "F:/IIT_final_yr/Myproject/FypModel/pythonProject8/datasets/smoke_dataset/test/smoke/M_00000.png"
                # raindrop_gt_path = "F:/IIT_final_yr/Myproject/FypModel/pythonProject8/datasets/smoke_dataset/test/smoke-free/M_00000.png"

                raindrop_img_path = "datasets/smoke_dataset/test/smoke/M_00000.png"
                raindrop_gt_path = "datasets/smoke_dataset/test/smoke-free/M_00000.png"
            ...
            print("This could be due to the use of deprecated NumPy aliases.")
            print("Consider updating your code to use 'bool' instead of 'np.bool'.")
            # Optionally, you can add more detailed instructions or logging here
            # to guide the user on how to fix the issue.