...
_C.DATASET.NAME = "smoke_dataset"  # Updated to use only SmokeDataset
# _C.DATASET.RAINDROP_ROOT = "./datasets/smoke_dataset/train"  # Updated root directory to smoke_dataset
# _C.DATASET.RAINDROP_ROOT = "F:/IIT_final_yr/Myproject/FypModel/pythonProject8/datasets/smoke_dataset"  # Updated root directory to smoke_dataset
_C.DATASET.RAINDROP_ROOT = "datasets/smoke_dataset"  # Updated root directory to smoke_dataset
# _C.DATASET.RAINDROP_ROOT = "F:/IIT_final_yr/Myproject/FypModel/pythonProject8/datasets/smoke_dataset/train"  # Updated root directory to smoke_dataset
_C.DATASET.SIZE = 256
...
# This is to run this file seperately
